...
if __name__ == '__main__':
    s = T.datetime.now()
    print("################# This program is Neural Network Model ################################")
    ...
    nameOfFile = file[selectTrain].replace('Trainset_','').replace('SeparateEachEpochPerRow','NeuronNetwork').replace(".csv", ".txt")
    ...
    for train_index, test_index in kf.split(X_train):
        model_Cross = model#MLPClassifier(activation='logistic',solver='adam', alpha=1e-5,learning_rate='adaptive',max_iter=1000)
