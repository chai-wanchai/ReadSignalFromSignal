...
if __name__ == '__main__':
    s = T.datetime.now()
    print("################# This program is "+modelName+"Model ################################")
    ...
    nameOfFile = file[selectTrain].replace('Trainset_','').replace('SeparateEachEpochPerRow',modelName).replace(".csv", ".txt")
    ...
    for train_index, test_index in kf.split(X_train):
        ...
        model_Cross.fit(X_train_Cross, y_train_Cross,sample_weight=None)
